...
def main():
    with open('../../processed_data/880/var.json') as jsonFile:
    ...
    with open('../../processed_data/880/varC.json','w') as jsonFile:
        json.dump(toC, jsonFile)
        
    with open('../../processed_data/880/varF.json','w') as jsonFile:
